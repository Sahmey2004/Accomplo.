...
-- Update RLS policies for accomplishments to use profile_id
DROP POLICY "Users can view their own accomplishments" ON public.accomplishments;
DROP POLICY "Users can insert their own accomplishments" ON public.accomplishments;
